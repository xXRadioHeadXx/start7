...
bool Control::pass_to_add_GROUP(UnitNode *unit, UnitNode* parrent,TreeModelUnitNode *modelTreeUN)
{
...
bool Control::pass_to_add_IU_BL_IP(UnitNode *unit, UnitNode *parent,TreeModelUnitNode *modelTreeUN)
{
...
bool Control::pass_to_add_BOD_SOTA(UnitNode *unit, UnitNode *parrent,TreeModelUnitNode *modelTreeUN)
{
...
bool Control::pass_to_add_Y4_SOTA(UnitNode *unit, UnitNode *parrent,TreeModelUnitNode *modelTreeUN)
{
...
bool Control::pass_to_add_DD_SOTA(UnitNode *unit, UnitNode* parrent,TreeModelUnitNode *modelTreeUN) //номера ДД можно добавлять только один раз в участки 1-2 и 3-4
{
...
bool Control::pass_to_add_BOD_T4K_M(UnitNode *unit, UnitNode* parrent,TreeModelUnitNode *modelTreeUN)
{
    //БОД может быть добавлен только к группе
    if((parrent->getType()!=TypeUnitNode::GROUP)&&
       (parrent->getType()!=TypeUnitNode::SYSTEM)
...
bool Control::pass_to_add_Y4_T4K_M(UnitNode *unit, UnitNode* parrent,TreeModelUnitNode *modelTreeUN)
{
...
bool Control::pass_to_add_DD_T4K_M(UnitNode *unit, UnitNode* parrent,TreeModelUnitNode *modelTreeUN)//номера ДД можно добавлять только один раз в участки 1-2 и 3-4
{
    //добавлять только к участку Сота
...
bool Control::pass_to_add_TG(UnitNode *unit, UnitNode* parrent,TreeModelUnitNode *modelTreeUN)
{
...
bool Control::pass_to_add_RLM_KRL(UnitNode *unit, UnitNode* parrent,TreeModelUnitNode *modelTreeUN)
{
...
bool Control::pass_to_add_RLM_C(UnitNode *unit, UnitNode* parrent,TreeModelUnitNode *modelTreeUN)
{
    if(parrent->getType()!=TypeUnitNode::GROUP)
    if(parrent->getType()!=TypeUnitNode::SYSTEM)
    {
...
bool Control::pass_to_add_KL(UnitNode *unit, UnitNode* parrent,TreeModelUnitNode *modelTreeUN)
{
      //qDebug()<<"[----------------------------------------------]";
...
bool Control::pass_to_add_ONVIF(UnitNode *unit, UnitNode *parent,TreeModelUnitNode *modelTreeUN)
{
...
bool Control::pass_to_add_STRAZH_IP(UnitNode *unit, UnitNode* parrent,TreeModelUnitNode *modelTreeUN)
{
    //может быть добавлен к любому датчику группе системе сморти ссои конфигуратор
...
bool  Control::pass_to_add_NET_DEV(UnitNode */*unit*/, UnitNode *parrent,TreeModelUnitNode *modelTreeUN)
{
    if(parrent->getType()!=TypeUnitNode::GROUP)
    if(parrent->getType()!=TypeUnitNode::SYSTEM)
    {
...
bool Control::pass_to_add_SSOI_SD(UnitNode *unit, UnitNode *parrent,TreeModelUnitNode *modelTreeUN)
{
    //СД может быть добавлен только к группе или к системе
        if((parrent->getType()!=TypeUnitNode::GROUP)&&(parrent->getType()!=TypeUnitNode::SYSTEM))
        {
...
bool Control::pass_to_add_SSOI_IU(UnitNode *unit, UnitNode *parent,TreeModelUnitNode *modelTreeUN)
{
    //может быть добавлен к любому датчику группе системе сморти ссои конфигуратор
    if((parent->getType()==TypeUnitNode::STRAZH_IP)||
       (parent->getType()==TypeUnitNode::ONVIF)||
...
bool Control::pass_to_add_TOROS(UnitNode *unit, UnitNode *parrent,TreeModelUnitNode *modelTreeUN)
{
...
bool Control::pass_to_add_RASTRMTV(UnitNode *unit, UnitNode *parrent,TreeModelUnitNode *modelTreeUN)
{
    //qDebug()<<"RASTRMTV";
    if((parrent->getType()==TypeUnitNode::STRAZH_IP)||
       (parrent->getType()==TypeUnitNode::ONVIF)||
...
bool Control::pass_to_add_INFO_TABLO(UnitNode *unit, UnitNode *parrent,TreeModelUnitNode *modelTreeUN)
{
    if(parrent->getType()!=TypeUnitNode::GROUP)
    if(parrent->getType()!=TypeUnitNode::SYSTEM)
    {
...
bool Control::correct_UDP_parametres(UnitNode *unit)
{
