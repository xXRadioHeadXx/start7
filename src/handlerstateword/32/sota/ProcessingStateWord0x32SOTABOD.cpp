...
ProcessingStateWord0x32SOTABOD::ProcessingStateWord0x32SOTABOD(const StateWord &data, const QSharedPointer<UnitNode> &un) :
    ProcessingStateWordAbstract(data, un)
{

}

ProcessingStateWord0x32SOTABOD::~ProcessingStateWord0x32SOTABOD()
{
...
//        qDebug() << "ProcessingStateWord0x32SOTABOD::processing(1) <--";
        return false;
    }
