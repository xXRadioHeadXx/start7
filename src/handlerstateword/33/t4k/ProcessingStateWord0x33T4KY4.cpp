...
#include "../src/statewordparsers/swpt4k/SWPT4KDDCFType0x33.h"
...
ProcessingStateWord0x33T4KY4::ProcessingStateWord0x33T4KY4(const StateWord &data, const QSharedPointer<UnitNode> &un) :
    ProcessingStateWordAbstract(data, un)
{

}

ProcessingStateWord0x33T4KY4::~ProcessingStateWord0x33T4KY4()
{
...
//        qDebug() << "PortManager::procT4KMY4StatusWord0x33(5) <--";
        return true;
    }
...
//    qDebug() << "PortManager::procT4KMY4StatusWord0x33() -- isChangedStatus " << isChangedStatus;
...
//    qDebug() << "PortManager::procT4KMY4StatusWord0x33() -- isSwitchReady " << isSwitchReady;
...
//    qDebug() << "PortManager::procT4KMY4StatusWord0x33() -- isFirstWakeUp " << isFirstWakeUp;
...
//    qDebug() << "PortManager::procT4KMY4StatusWord0x33() -- isWakeUp " << isWakeUp;
...
//    qDebug() << "PortManager::procT4KMY4StatusWord0x33 -- needResetFlags0x24 y4("<< y4 <<")" << needResetFlags0x24;
...
//    qDebug() << "PortManager::procT4KMY4StatusWord0x33 -- makedResetFlags0x24 y4("<< y4 <<")" << makedResetFlags0x24;
...
//    qDebug() << "PortManager::procT4KMY4StatusWord0x33(X) <--";
    return true;
}
