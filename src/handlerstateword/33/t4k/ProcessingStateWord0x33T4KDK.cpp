...
ProcessingStateWord0x33T4KDK::ProcessingStateWord0x33T4KDK(const StateWord &data, const QSharedPointer<UnitNode> &un) :
    ProcessingStateWordAbstract(data, un)
{

}

ProcessingStateWord0x33T4KDK::~ProcessingStateWord0x33T4KDK()
{

}

bool ProcessingStateWord0x33T4KDK::processing(const StateWord &data, const QSharedPointer<UnitNode> &currentUN) const
{
...
void ProcessingStateWord0x33T4KDK::finishDKWaiter(QSharedPointer<AbstractRequester> ar) const {
    if(RequesterType::DKWaiter == ar->getRequesterType()) {
...
void ProcessingStateWord0x33T4KDK::procDK(const QSharedPointer<UnitNode> &current, const QSharedPointer<UnitNode> &previous) const {
