...
ProcessingStateWord0x33TG::ProcessingStateWord0x33TG(const StateWord &data, const QSharedPointer<UnitNode> &un) :
    ProcessingStateWordAbstract(data, un)
{

}

ProcessingStateWord0x33TG::~ProcessingStateWord0x33TG()
{

}

bool ProcessingStateWord0x33TG::processing(const StateWord &data, const QSharedPointer<UnitNode> &currentUN) const
{
...
//    qDebug() << "PortManager::procTgStatusWord0x33 -- needResetFlags0x24" << needResetFlags0x24;
    if(needResetFlags0x24) {
        auto msMsg = QSharedPointer<ManagerSingleMsg>::create(currentUN,
                                                              DataQueueItem::makeResetFlags0x24);
        reciver->pushBackUniqManagerSingleMsg(msMsg);
    }
//    qDebug() << "PortManager::procTgStatusWord0x33 -- makedResetFlags0x24" << makedResetFlags0x24;
